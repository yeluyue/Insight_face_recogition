...
class MobileFaceNet(Module):
    def __init__(self, embedding_size):
        ...
        self.conv_56 = Depth_Wise(128, 256, kernel=(3, 3), stride=(2, 2), padding=(1, 1), groups=1024)
        ...
        self.conv_6_dw = Linear_block(512, 512, groups=512, kernel=(3, 3), stride=(1, 1), padding=(0, 0))
