...
class ShuffleNetV2(nn.Module):
    ...
    def __init__(self, scale=1.0, in_channels=3, c_tag=0.5, num_classes=512, activation=nn.ReLU,
        ...
        self.activation_type = activation  # 设定激活函数类型
        self.activation = activation(inplace=True)
        self.num_classes = num_classes

        self.num_of_channels = {0.5: [24, 48, 96, 192, 512], 1: [24, 116, 232, 464, 512],
