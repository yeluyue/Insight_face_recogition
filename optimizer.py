...
def get_parser():
    ...
    parser.optim = 'adabound'  # optimizer,sgd, adagrad, adam, amsgrad, adabound, amsbound
    parser.lr = 1e-3  # learning rate
    parser.final_lr = 0.1  # final learning rate of AdaBound
    parser.gamma = 1e-3  # convergence speed term of AdaBound
    parser.momentum = 0.9  # momentum term
    parser.beta1 = 0.9  # Adam coefficients beta_1
    parser.beta2 = 0.999  # Adam coefficients beta_2
    parser.resume = True  # resume from checkpoint
    parser.weight_decay = 5e-4  # weight decay for optimizers
